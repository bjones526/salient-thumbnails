...
output('a document in which someone declines to add his or her name to Graham&#39;s proposed statement and expresses regret that Social Security has become a partisan issue', 1, 'full', 'Economic Security Council', 'EconomicSecurityCouncil', "2.html");
output('a document from a librarian that mentions receiving a donation', 2, 'salient', 'Citizen&#39;s Library Movement', 'CitizensLibraryMovement', "3.html");
output('a document signed by Graham&#39;s vice-chairman, Paul Kellogg, that mentions the New York Herald Tribune', 3, 'full', 'Economic Security Council', 'EconomicSecurityCouncil', "4.html");
output('a document written by Frank Porter Graham that encourages someone to join the finance committee', 4, 'salient', 'Citizen&#39;s Library Movement', 'CitizensLibraryMovement', "message.html");
